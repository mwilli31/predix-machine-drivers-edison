...
"echo \'ExecStart=/usr/bin/python \'$driverpath\'/" + str(driverData["name"]) + "\' >> /etc/systemd/system/" + kitName + ".service\n" +
"echo \'Environment=PYTHONUNBUFFERED=1\' >> /etc/systemd/system/" + kitName + ".service\n" +
